    ...
    <main>
      <section className="relative overflow-hidden max-w-7xl mx-auto px-5 md:px-0 py-20 md:py-25 flex flex-col md:flex-row items-center justify-between">
        <div className="max-w-121 flex flex-col items-center md:items-start gap-3 md:gap-4 text-secondary">
          <h2 className="font-roboto-mono text-sm md:text-xl">Discover the Nature with</h2>
          <h1 className="font-roboto-mono text-primary text-5xl md:text-[90px] font-medium">ANNIQCLEO</h1>
      ...
      <TextBanner />
      <section className="py-25 px-5 md:px-0">
        <div
      ...
      <FeaturedProducts />
      <TextBanner />
      <section className="max-w-7xl mx-auto py-20 px-5 md:px-0">
        <div className="flex flex-col md:flex-row items-center md:justify-between text-primary mb-20">
          <h1 className="text-sm md:text-3xl font-roboto-mono">Made for you, loved by you</h1>
